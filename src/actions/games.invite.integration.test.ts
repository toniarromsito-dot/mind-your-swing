...
function createGameFormData(opts: { courseId: string; courseLayoutId: string; courseTeeId: string; playerCount?: number }) {
  ...
  // STROKE_PLAY (no DUEL): modo gratuito — este archivo prueba invitación/join, no
  // el bypass de modos Pro (ver games.mode-access.integration.test.ts, Fase 11A),
  // y el creador de estos fixtures no tiene por qué tener plan Pro.
